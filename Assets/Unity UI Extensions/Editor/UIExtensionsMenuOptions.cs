...
namespace Unity_UI_Extensions.Editor
{
	/// <summary>
	...
	internal static class ExtensionMenuOptions
    {
        ...
        static readonly Vector2 s_ThickGUIElementSize = new(kWidth, kThickHeight);
        static readonly Vector2 s_ThinGUIElementSize = new(kWidth, kThinHeight);
        static readonly Vector2 s_ImageGUIElementSize = new(100f, 100f);
        static readonly Color s_DefaultSelectableColor = new(1f, 1f, 1f, 1f);
        static readonly Color s_TextColor = new(50f / 255f, 50f / 255f, 50f / 255f, 1f);
        ...
        static void SetPositionVisibleinSceneView(RectTransform canvasRTransform, RectTransform itemTransform)
        {
            ...
            if (RectTransformUtility.ScreenPointToLocalPointInRectangle(
                    canvasRTransform, new Vector2(camera.pixelWidth / 2, camera.pixelHeight / 2), camera,
        ...
        public static void AddVerticallScrollSnap(MenuCommand menuCommand)
        {
            ...
            rectTransformPage01.anchoredPosition = new Vector2(
                -rectTransformPage01.sizeDelta.x / 2, rectTransformPage01.sizeDelta.y / 2);
        ...
        {
            FixedScrollSnapBase(
                menuCommand, "Scroll Snap Horizontal Single", ScrollSnap.ScrollDirection.Horizontal, 1, 3,
                new Vector2(100, 100));
        }
        ...
        {
            FixedScrollSnapBase(
                menuCommand, "Scroll Snap Horizontal Multiple", ScrollSnap.ScrollDirection.Horizontal, 3, 15,
                new Vector2(100, 100));
        }
        ...
        {
            FixedScrollSnapBase(
                menuCommand, "Scroll Snap Vertical Multiple", ScrollSnap.ScrollDirection.Vertical, 1, 3,
                new Vector2(100, 100));
        }
        ...
        {
            FixedScrollSnapBase(
                menuCommand, "Scroll Snap Vertical Multiple", ScrollSnap.ScrollDirection.Vertical, 3, 15,
                new Vector2(100, 100));
        }
        ...
        public static void AddUIHorizontalScroller(MenuCommand menuCommand)
        {
            var uiHorizontalScrollerRoot = CreateUIElementRoot(
                "UI Horizontal Scroller", menuCommand, s_ThickGUIElementSize);
        ...
        static void CreateAccordionGroup(GameObject go)
        {
        ...
        static void CreateAccordionElement(GameObject go)
        {
            var vlg = go.AddComponent<VerticalLayoutGroup>();
            vlg.childControlHeight = true;
            vlg.childControlWidth = true;
        ...
        public static void AddAutoCompleteComboBox(MenuCommand menuCommand)
        {
            ...
            UnityEventTools.AddPersistentListener(
                inputField.GetComponent<InputField>().onValueChanged, autoCompleteComboBox.OnValueChanged);
            ...
            UnityEventTools.AddBoolPersistentListener(
                overlay.AddComponent<Button>().onClick, autoCompleteComboBox.ToggleDropdownPanel, true);
            ...
            UnityEventTools.AddBoolPersistentListener(
                arrowButton.GetComponent<Button>().onClick, autoCompleteComboBox.ToggleDropdownPanel, true);
        ...
        public static void AddComboBox(MenuCommand menuCommand)
        {
            ...
            inputFieldRT.sizeDelta = Vector2.zero;
            UnityEventTools.AddPersistentListener(
                inputField.GetComponent<InputField>().onValueChanged, comboBox.OnValueChanged);
            ...
            overlay.AddComponent<Image>().color = new Color(0.243f, 0.871f, 0f, 0f);
            UnityEventTools.AddBoolPersistentListener(
                overlay.AddComponent<Button>().onClick, comboBox.ToggleDropdownPanel, true);
            ...
            arrowButtonRT.pivot = Vector2.one;
            UnityEventTools.AddBoolPersistentListener(
                arrowButton.GetComponent<Button>().onClick, comboBox.ToggleDropdownPanel, true);
        ...
        public static void AddDropDownList(MenuCommand menuCommand)
        {
            ...
            UnityEventTools.AddBoolPersistentListener(
                mainButton.GetComponent<Button>().onClick, dropDownList.ToggleDropdownPanel, true);
            ...
            overlay.AddComponent<Image>().color = new Color(0.243f, 0.871f, 0f, 0f);
            UnityEventTools.AddBoolPersistentListener(
                overlay.AddComponent<Button>().onClick, dropDownList.ToggleDropdownPanel, true);
        ...
        static void CreateToolTipItem(bool select)
        {
            CreateToolTipItem(select, null);
        }

        static void CreateToolTipItem(bool select, GameObject parent)
        {
        ...
        static GameObject AddInputFieldAsChild(GameObject parent)
        {
        ...
        static GameObject AddScrollbarAsChild(GameObject parent)
        {
            // Create GOs Hierarchy
        ...
        static GameObject AddTextAsChild(GameObject parent)
        {
        ...
        static GameObject AddImageAsChild(GameObject parent)
        {
        ...
        static GameObject AddButtonAsChild(GameObject parent)
        {
        ...
        static RectTransform SetAnchorsAndStretch(GameObject root)
        {
